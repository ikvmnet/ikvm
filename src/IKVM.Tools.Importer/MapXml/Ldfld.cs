...
namespace IKVM.Tools.Importer.MapXml
{
    ...
    public sealed class Ldfld : Instruction
    {
        ...
        /// <returns></returns>
        public static new Ldfld Read(XElement element)
        {
            var inst = new Ldfld();
            Load(inst, element);
            return inst;
        ...
        /// <param name="element"></param>
        public static void Load(Ldfld inst, XElement element)
        {
        ...
        internal override void Generate(CodeGenContext context, CodeEmitter ilgen)
        {
            ...
            ilgen.Emit(OpCodes.Ldfld, context.ClassLoader.Context.StaticCompiler.GetFieldForMapXml(context.ClassLoader, Class, Name, Sig).GetField());
        }
