...
namespace IKVM.Tools.Importer
{
    ...
    public sealed class IkvmImporterTool
    {
        ...
        static Task<int> Compile(string[] args)
        {
            ...
            IkvmImporterTool comp = new IkvmImporterTool();
            ...
            try
            {
                return Task.FromResult(CompilerClassLoader.Compile(runtimeAssembly, targets));
            }
        ...
        {
            var asm = typeof(IkvmImporterTool).Assembly;
        ...
        void ContinueParseCommandLine(IEnumerator<string> arglist, List<CompilerOptions> targets, CompilerOptions options)
        {
            ...
            while (arglist.MoveNext())
            {
                ...
                if (s == "{")
                {
                    ...
                    IkvmImporterTool nestedLevel = new IkvmImporterTool();
