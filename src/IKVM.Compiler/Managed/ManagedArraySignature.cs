...
namespace IKVM.Compiler.Managed
{
    ...
    internal readonly partial struct ManagedArraySignature
    {
        ...
        /// <returns></returns>
        internal ManagedArraySignature(in ManagedSignatureData elementTypeData, int rank)
        {
            ManagedSignatureData.Write(new ManagedSignatureCodeData(ManagedSignatureKind.Array, new ManagedArrayShape(rank)), elementTypeData, null, null, out data);
        }
