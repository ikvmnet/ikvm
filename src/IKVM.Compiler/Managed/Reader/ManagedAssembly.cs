...
namespace IKVM.Compiler.Managed.Reader
{
    ...
    internal sealed class ManagedAssembly
    {
        ...
        readonly IManagedReaderContext context;
        ...
        public ManagedAssembly(IManagedReaderContext context, object handle, AssemblyName name)
        {
        ...
        /// </summary>
        public IManagedReaderContext Context => context;
        ...
        /// </summary>
        public ManagedAssemblyModuleList Modules
        {
            get
            {
                LazyLoad();
                return new ManagedAssemblyModuleList(this);
            }
        }
