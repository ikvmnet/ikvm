...
namespace IKVM.Compiler.Managed.Reader
{
    ...
    internal readonly partial struct ManagedAssemblyModuleList : IReadOnlyList<ManagedModule>, IEnumerable<ManagedModule>
    {

        /// <summary>
        /// Provides an enumerator that iterates over the items in the list.
        /// </summary>
        public struct Enumerator : IEnumerator<ManagedModule>
        {
            ...
            /// </summary>
            /// <returns></returns>
            public bool MoveNext() => assembly.data.Modules.Count > ++index;

            /// <summary>
            /// Gets a reference to the current item.
            /// </summary>
            public readonly ManagedModule Current => new ManagedModule(assembly, index);
            ...
            /// <inheritdoc />
            readonly ManagedModule IEnumerator<ManagedModule>.Current => Current;
        ...
        /// </summary>
        /// <param name="assembly"></param>
        public ManagedAssemblyModuleList(ManagedAssembly assembly) => this.assembly = assembly;
        ...
        /// <param name="index"></param>
        /// <returns></returns>
        public readonly ManagedModule this[int index] => new ManagedModule(assembly, index);

        /// <summary>
        /// Gets the count of items in the list.
        /// </summary>
        public readonly int Count => assembly.data.Modules.Count;
        ...
        /// <inheritdoc />
        ManagedModule IReadOnlyList<ManagedModule>.this[int index] => this[index];

        /// <inheritdoc />
        IEnumerator<ManagedModule> IEnumerable<ManagedModule>.GetEnumerator() => GetEnumerator();
