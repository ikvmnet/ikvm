...
namespace IKVM.Compiler.Managed.Reader.Reflection
{
    ...
    /// </summary>
    internal sealed class ReflectionReaderContext : IManagedReaderContext, IManagedAssemblyResolver
    {
        ...
        readonly ConcurrentDictionary<System.Type, ManagedType> typeCache = new();
        readonly ConcurrentDictionary<System.Type, ManagedExportedType> exportedTypeCache = new();

        /// <summary>
        /// Initializes a new instance.
        /// </summary>
        /// <param name="resolver"></param>
        public ReflectionReaderContext(IReflectionAssemblyResolver resolver)
        {
            this.resolver = resolver;
        }

        /// <summary>
        /// Implements the <see cref="IManagedReaderContext.LoadAssembly(ManagedAssembly, out ManagedAssemblyData)" /> method.
        /// </summary>
        /// <param name="assembly"></param>
        /// <param name="data"></param>
        /// <returns></returns>
        void IManagedReaderContext.LoadAssembly(ManagedAssembly assembly, out ManagedAssemblyData data) => LoadAssembly(assembly, out data);

        /// <summary>
        /// Implements the <see cref="IManagedReaderContext.ResolveTypes(ManagedAssembly)"/> method.
        /// </summary>
        /// <param name="assembly"></param>
        /// <returns></returns>
        IEnumerable<ManagedType> IManagedReaderContext.ResolveTypes(ManagedAssembly assembly) => ResolveTypes(assembly);

        /// <summary>
        /// Implements the <see cref="IManagedReaderContext.ResolveType(ManagedAssembly, string)"/> method.
        /// </summary>
        /// <param name="assembly"></param>
        /// <param name="typeName"></param>
        /// <returns></returns>
        ManagedType? IManagedReaderContext.ResolveType(ManagedAssembly assembly, string typeName) => ResolveType(assembly, typeName);

        /// <summary>
        /// Implements the <see cref="IManagedReaderContext.ResolveExportedTypes(ManagedAssembly)"/> method.
        /// </summary>
        /// <param name="assembly"></param>
        /// <returns></returns>
        IEnumerable<ManagedExportedType> IManagedReaderContext.ResolveExportedTypes(ManagedAssembly assembly) => ResolveExportedTypes(assembly);

        /// <summary>
        /// Implements the <see cref="IManagedReaderContext.ResolveExportedType(ManagedAssembly, string)"/> method.
        /// </summary>
        /// <param name="assembly"></param>
        /// <param name="typeName"></param>
        /// <returns></returns>
        ManagedExportedType? IManagedReaderContext.ResolveExportedType(ManagedAssembly assembly, string typeName) => ResolveExportedType(assembly, typeName);

        /// <summary>
        /// Implements the <see cref="IManagedReaderContext.LoadType(ManagedType,  out ManagedTypeData)"/> method.
        /// </summary>
        /// <param name="type"></param>
        /// <param name="result"></param>
        void IManagedReaderContext.LoadType(ManagedType type, out ManagedTypeData result) => LoadType(type, out result);

        /// <summary>
        /// Implements the <see cref="IManagedReaderContext.ResolveNestedTypes(ManagedType)"/> method.
        /// </summary>
        /// <param name="type"></param>
        /// <returns></returns>
        IEnumerable<ManagedType> IManagedReaderContext.ResolveNestedTypes(ManagedType type) => ResolveNestedTypes(type);

        /// <summary>
        /// Implements the <see cref="IManagedReaderContext.ResolveNestedType(ManagedType,  string)"/> method.
        /// </summary>
        /// <param name="type"></param>
        /// <param name="typeName"></param>
        /// <returns></returns>
        ManagedType? IManagedReaderContext.ResolveNestedType(ManagedType type, string typeName) => ResolveNestedType(type, typeName);
        ...
        /// <returns></returns>
        ManagedType? ResolveType(System.Type refType)
        {
        ...
        /// <param name="refType"></param>
        /// <returns></returns>
        ManagedType CreateType(ManagedAssembly assembly, System.Type refType)
        {
        ...
        /// <returns></returns>
        IEnumerable<ManagedType> ResolveTypes(ManagedAssembly assembly, System.Type[] refTypes)
        {
        ...
        /// <param name="refTypes"></param>
        /// <returns></returns>
        IEnumerable<ManagedExportedType> ResolveExportedTypes(ManagedAssembly assembly, System.Type[] refTypes)
        {
            for (int i = 0; i < refTypes.Length; i++)
        ...
        /// <param name="refType"></param>
        /// <returns></returns>
        ManagedExportedType ResolveExportedType(ManagedAssembly assembly, System.Type refType)
        {
        ...
        /// <param name="refType"></param>
        /// <returns></returns>
        ManagedExportedType CreateExportedType(ManagedAssembly assembly, System.Type refType)
        {
        ...
        {
            var refType = (System.Type)type.Handle;
            if (refType == null)
        ...
        /// <param name="refType"></param>
        /// <returns></returns>
        ManagedSignature ResolveSignature(System.Type refType)
        {
#if NETFRAMEWORK
        ...
        /// <param name="refType"></param>
        /// <returns></returns>
        ManagedSignature ResolveGenericSignature(System.Type refType)
        {
        ...
        /// <param name="result"></param>
        /// <returns></returns>
        void LoadTypeGenericParameters(ManagedType type, System.Type[] refParameterList, out FixedValueList1<ManagedGenericParameterData> result)
        {
        ...
        /// <param name="result"></param>
        /// <returns></returns>
        void LoadTypeGenericParameter(ManagedType type, System.Type refParameter, out ManagedGenericParameterData result)
        {
        ...
        /// <param name="result"></param>
        /// <returns></returns>
        void LoadTypeGenericParameterConstraints(ManagedType type, System.Type[] refConstraintList, out FixedValueList1<ManagedGenericParameterConstraintData> result)
        {
        ...
        /// <param name="result"></param>
        /// <returns></returns>
        void LoadTypeGenericParameterConstraint(ManagedType type, System.Type refConstraint, out ManagedGenericParameterConstraintData result)
        {
        ...
        /// <returns></returns>
        void LoadTypeInterfaces(ManagedType type, System.Type[] refInterfaceList, out FixedValueList2<ManagedInterfaceData> result)
        {
        ...
        /// <returns></returns>
        void LoadTypeInterface(ManagedType type, System.Type refInterface, out ManagedInterfaceData result)
        {
