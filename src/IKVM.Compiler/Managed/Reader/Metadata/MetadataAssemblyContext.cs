...
namespace IKVM.Compiler.Managed.Reader.Metadata
{
    ...
    /// </summary>
    internal class MetadataAssemblyContext : IManagedReaderContext, IManagedAssemblyResolver
    {
        ...
        public MetadataAssemblyContext(IMetadataReaderResolver resolver, string? coreAssemblyName = null)
        {
            ...
            signatureTypeProvider = new MetadataSignatureTypeProvider(this, this.coreAssemblyName);
        }
        ...
        /// <summary>
        /// Implements the <see cref="IManagedReaderContext.ResolveExportedTypes(ManagedAssembly, string)"/> method.
        /// </summary>
        /// <param name="assembly"></param>
        /// <returns></returns>
