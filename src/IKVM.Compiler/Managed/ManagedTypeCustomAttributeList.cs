...
namespace IKVM.Compiler.Managed
{
    ...
    public readonly struct ManagedTypeCustomAttributeList : IReadOnlyList<ManagedCustomAttribute>, IEnumerable<ManagedCustomAttribute>
    {
        ...
        public struct Enumerator : IEnumerator<ManagedCustomAttribute>
        {
            ...
            /// </summary>
            /// <returns></returns>
            public bool MoveNext() => type.CustomAttributes.Count > ++pos;

            /// <summary>
            /// Gets a reference to the current item.
            /// </summary>
            public readonly ref readonly ManagedCustomAttribute Current => ref type.data.CustomAttributes.GetItemRef(pos);
        ...
        /// <returns></returns>
        public readonly ref readonly ManagedCustomAttribute this[int index] => ref type.data.CustomAttributes.GetItemRef(index);
