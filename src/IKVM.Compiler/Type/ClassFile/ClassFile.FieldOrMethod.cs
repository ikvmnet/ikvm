...
namespace IKVM.Compiler.Type.ClassFile
{
    ...
    sealed partial class ClassFile
    {
        ...
        internal abstract class FieldOrMethod : IEquatable<FieldOrMethod>
        {
            ...
            internal bool IsAbstract => (accessFlags & AccessFlag.ACC_ABSTRACT) != 0;

            internal bool IsFinal => (accessFlags & AccessFlag.ACC_FINAL) != 0;

            internal bool IsPublic => (accessFlags & AccessFlag.ACC_PUBLIC) != 0;
            ...
            internal bool IsEnum => (accessFlags & AccessFlag.ACC_ENUM) != 0;
