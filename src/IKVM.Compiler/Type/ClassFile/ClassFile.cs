...
namespace IKVM.Compiler.Type.ClassFile
{
    ...
    sealed partial class ClassFile
    {
        ...
        internal void Link(JavaClassType thisType, LoadMode mode)
        {
        ...
        internal bool IsAbstract
        {
            get
            {
                ...
                return (access_flags & (AccessFlag.ACC_ABSTRACT | AccessFlag.ACC_INTERFACE)) != 0;
            }
        }

        internal bool IsFinal => (access_flags & AccessFlag.ACC_FINAL) != 0;

        internal bool IsPublic => (access_flags & AccessFlag.ACC_PUBLIC) != 0;

        internal bool IsInterface => (access_flags & AccessFlag.ACC_INTERFACE) != 0;

        internal bool IsEnum => (access_flags & AccessFlag.ACC_ENUM) != 0;

        internal bool IsAnnotation => (access_flags & AccessFlag.ACC_ANNOTATION) != 0;

        internal bool IsSuper => (access_flags & AccessFlag.ACC_SUPER) != 0;
        ...
        internal JavaClassType GetConstantPoolClassType(int index)
        {
