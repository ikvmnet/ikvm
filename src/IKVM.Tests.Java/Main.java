...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final AtomicIntegerFieldUpdater<Main> iu =
            AtomicIntegerFieldUpdater.newUpdater(Main.class, "ii");
        final AtomicLongFieldUpdater<Main> lu =
            AtomicLongFieldUpdater.newUpdater(Main.class, "ll");
        final AtomicReferenceFieldUpdater<Main,Boolean> ru =
