...
Install the `IKVM.Sdk` package in a project that wants to reference Java libraries. Use the `IkvmReference` `ItemGroup`
...
`IkvmReference` to customize the generated assembly.
