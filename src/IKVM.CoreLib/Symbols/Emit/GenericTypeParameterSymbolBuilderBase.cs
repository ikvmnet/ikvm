...
namespace IKVM.CoreLib.Symbols.Emit
{
    ...
    class GenericTypeParameterSymbolBuilderBase : IGenericTypeParameterSymbolBuilder
    {
        ...
        /// <inheritdoc />
        public virtual IMemberSymbol[] GetMembers(string name)
        {
            return ResolveMemberSymbols(UnderlyingType.GetMember(name));
        }

        /// <inheritdoc />
        public virtual IMemberSymbol[] GetMembers(string name, BindingFlags bindingAttr)
        {
            return ResolveMemberSymbols(UnderlyingType.GetMember(name, bindingAttr));
        }

        /// <inheritdoc />
        public virtual IMemberSymbol[] GetMembers(string name, MemberTypes type, BindingFlags bindingAttr)
        {
