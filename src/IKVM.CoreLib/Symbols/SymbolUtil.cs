...
namespace IKVM.CoreLib.Symbols
{
    ...
    static class SymbolUtil
    {
        ...
        /// <param name="flags"></param>
        /// <returns></returns>
        public static bool BindingFlagsMatch(MethodSymbol member, BindingFlags flags)
        {
        ...
        /// <param name="flags"></param>
        /// <returns></returns>
        public static bool BindingFlagsMatchInherited(MethodSymbol method, BindingFlags flags)
        {
