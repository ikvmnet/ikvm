...
namespace IKVM.CoreLib.Symbols.Reflection
{
    ...
    sealed class ReflectionGenericTypeParameterTypeSymbol : DefinitionGenericTypeParameterTypeSymbol
    {
        ...
        public ReflectionGenericTypeParameterTypeSymbol(ReflectionSymbolContext context, Type underlyingType) :
            base(context)
        {
