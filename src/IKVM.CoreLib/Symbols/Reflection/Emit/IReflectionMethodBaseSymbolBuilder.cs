...
namespace IKVM.CoreLib.Symbols.Reflection.Emit
{
    ...
    interface IReflectionMethodBaseSymbolBuilder : IReflectionSymbolBuilder, IReflectionMemberSymbolBuilder, IMethodBaseSymbolBuilder, IReflectionMethodBaseSymbol
    {
