...
namespace IKVM.CoreLib.Symbols.Reflection
{
    ...
    class ReflectionAssemblyLoader : IAssemblyLoader
    {
        ...
        public ReflectionAssemblyLoader(ReflectionSymbolContext context, Assembly underlyingAssembly)
        {
        ...
        public ImmutableArray<ModuleSymbol> GetModules()
        {
            if (_modules == default)
            {
                ...
                foreach (var module in l)
                    b.Add(new DefinitionModuleSymbol(_context, new ReflectionModuleLoader(_context, module)));
