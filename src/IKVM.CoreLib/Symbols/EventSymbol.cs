...
namespace IKVM.CoreLib.Symbols
{
    ...
    public abstract class EventSymbol : MemberSymbol
    {
        ...
        protected EventSymbol(SymbolContext context) :
            base(context)
        {
        ...
        /// <summary>
        /// Specializes the current <see cref="EventSymbol"/> given the specified generic arguments.
        /// </summary>
        /// <param name="context"></param>
        /// <returns></returns>
        internal EventSymbol Specialize(GenericContext context)
        {
