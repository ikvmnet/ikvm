...
namespace IKVM.CoreLib.Symbols
{
    ...
    /// </summary>
    class ModuleTypeSymbolPolicy : MemberSymbolPolicy<ModuleSymbol, TypeSymbol>
    {

        /// <inheritdoc />
        public sealed override ImmutableArray<TypeSymbol> GetDeclaredMembers(ModuleSymbol module) => module.GetDeclaredTypes();

        /// <inheritdoc />
        public sealed override ModuleSymbol? GetInheritedParent(ModuleSymbol parent) => null;
