...
namespace IKVM.CoreLib.Symbols
{
    ...
    /// </summary>
    interface IMethodSymbol : ISymbol
    {
        ...
        /// <exception cref="InvalidOperationException">If this is not a reduced extension method.</exception>
        /// <exception cref="ArgumentNullException">If <paramref name="reducedFromTypeParameter"/> is null.</exception>
        /// <exception cref="ArgumentException">If <paramref name="reducedFromTypeParameter"/> doesn't belong to the corresponding <see cref="ReducedFrom"/> method.</exception>
        ...
        IMethodSymbol Construct(ImmutableArray<ITypeSymbol> typeArguments);
