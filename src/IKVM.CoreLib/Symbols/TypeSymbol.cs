...
namespace IKVM.CoreLib.Symbols
{
    ...
    /// <summary>
    /// Represents type declarations for class types, interface types, array types, value types, enumeration types,
    ...
    public abstract class TypeSymbol : MemberSymbol
    {
        ...
        protected TypeSymbol(SymbolContext context) :
            base(context)
        {
        ...
        /// </summary>
        public virtual string? FullName => _fullName ??= TypeSymbolNameBuilder.ToString(this, TypeSymbolNameBuilder.Format.FullName);
        ...
        /// </summary>
        public virtual bool ContainsMissingType => IsMissing || GenericParameters.Any(i => i.ContainsMissingType) || GetRequiredCustomModifiers().Any(i => i.ContainsMissingType) || GetOptionalCustomModifiers().Any(i => i.ContainsMissingType);
        ...
        /// </summary>
        public abstract ImmutableArray<TypeSymbol> GenericParameters { get; }
        ...
        /// <summary>
        /// Gets all the interfaces implemented by the current <see cref="TypeSymbol"/>.
        /// </summary>
        /// <returns></returns>
        ...
        public MethodSymbol? GetMethod(string name, int genericParameterCount, BindingFlags bindingFlags, CallingConventions callConvention, TypeSymbolSelectorList types, ImmutableArray<ParameterModifier> modifiers)
        {
            ...
            else
            {
                ...
                foreach (var method in results)
                {
                    ...
                    if (genericParameterCount != -1 && genericParameterCount != method.GenericParameters.Length)
                        continue;
        ...
        /// <summary>
        /// Specializes the type symbol from the given generic context.
        /// </summary>
        /// <param name="genericContext"></param>
        /// <returns></returns>
        internal abstract TypeSymbol Specialize(GenericContext genericContext);
