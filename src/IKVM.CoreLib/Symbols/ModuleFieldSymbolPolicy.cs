...
namespace IKVM.CoreLib.Symbols
{
    ...
    /// </summary>
    class ModuleFieldSymbolPolicy : MemberSymbolPolicy<ModuleSymbol, FieldSymbol>
    {

        /// <inheritdoc />
        public sealed override ImmutableArray<FieldSymbol> GetDeclaredMembers(ModuleSymbol module) => module.GetDeclaredFields();

        /// <inheritdoc />
        public override ModuleSymbol? GetInheritedParent(ModuleSymbol parent) => null;
