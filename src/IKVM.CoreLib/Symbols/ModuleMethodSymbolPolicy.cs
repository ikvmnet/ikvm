...
namespace IKVM.CoreLib.Symbols
{
    ...
    /// </summary>
    class ModuleMethodSymbolPolicy : MemberSymbolPolicy<ModuleSymbol, MethodSymbol>
    {

        /// <inheritdoc />
        public sealed override ImmutableArray<MethodSymbol> GetDeclaredMembers(ModuleSymbol module) => module.GetDeclaredMethods();
        ...
        /// <inheritdoc />
        public override ModuleSymbol? GetInheritedParent(ModuleSymbol parent)
        {
            return null;
        }
