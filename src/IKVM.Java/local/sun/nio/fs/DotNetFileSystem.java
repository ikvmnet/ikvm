...
final class DotNetFileSystem extends FileSystem {
    ...
    static final class NetWatchService implements WatchService {
        ...
        private final class NetWatchKey implements WatchKey {
            ...
            synchronized void init(final boolean create, final boolean delete, final boolean modify, final boolean overflow, final boolean subtree) throws IOException {
                try {
                    if (fsw != null) {
                    ...
                    fsw.add_Error(new ErrorEventHandler(new ErrorEventHandler.Method() {
                        public void Invoke(Object sender, ErrorEventArgs e) {
                            if (e.GetException() instanceof cli.System.ComponentModel.Win32Exception && ((cli.System.ComponentModel.Win32Exception)e.GetException()).get_ErrorCode() == -2147467259) {
                    ...
                    if (t instanceof cli.System.IO.FileNotFoundException) {
                        throw new java.nio.file.NoSuchFileException(((cli.System.IO.FileNotFoundException)t).get_FileName());
                    } else if (t instanceof cli.System.Exception) {
                        throw new IOException(((cli.System.Exception)t).get_Message(), t);
                    } else {
