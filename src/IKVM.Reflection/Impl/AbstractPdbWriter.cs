...
{
    abstract class AbstractPdbWriter : ISymbolWriterImpl
    {
        protected readonly ModuleBuilder moduleBuilder;
        protected readonly Dictionary<string, Document> documents = new Dictionary<string, Document>();
        protected readonly List<Method> methods = new List<Method>();
        protected readonly Dictionary<int, int> remap = new Dictionary<int, int>();
        protected readonly Dictionary<int, int> reversemap = new Dictionary<int, int>();
        protected readonly Dictionary<int, MethodBase> methodMap = new Dictionary<int, MethodBase>();
        protected Method currentMethod;

        internal AbstractPdbWriter(ModuleBuilder moduleBuilder)
        {
        ...
        protected sealed class Document : ISymbolDocumentWriter
        {
            ...
            internal Guid languageVendor;
            internal Guid documentType;
            internal object unmanagedDocument;
        ...
        public abstract byte[] GetDebugInfo(ref IMAGE_DEBUG_DIRECTORY idd);
