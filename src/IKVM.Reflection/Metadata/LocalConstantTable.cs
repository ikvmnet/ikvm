...
namespace IKVM.Reflection.Metadata
{
    ...
    sealed class LocalConstantTable : Table<LocalConstantTable.Record>
    {
        ...
        internal const int Index = (int)TableIndex.LocalConstant;
        ...
        internal override void Write(ModuleBuilder module)
        {
            ...
            {
                var h = module.Metadata.AddLocalConstant(records[i].Name, records[i].Signature);
                Debug.Assert(h == MetadataTokens.LocalConstantHandle(i + 1));
            }
        }
