    ...
    internal class RuntimeAssemblyClassLoader : RuntimeClassLoader
    {
        ...
        internal virtual RuntimeJavaType GetJavaTypeFromAssemblyType(ITypeSymbol type)
        {
            ...
            if (javaType != null)
            {
                ...
                {
#if IMPORTER
                    throw new DiagnosticEventException(DiagnosticEvent.AssemblyContainsDuplicateClassNames(type.FullName, javaType.TypeAsTBD.FullName, javaType.Name, type.Assembly.FullName));
#else
