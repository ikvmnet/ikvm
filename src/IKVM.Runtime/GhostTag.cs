...
namespace IKVM.Runtime
{
    ...
    static class GhostTag
    {
...
#else
            SetTag(obj, RuntimeClassLoader.GetWrapperFromType(Type.GetTypeFromHandle(typeHandle)));
#endif
        }
        ...
        internal static bool IsGhostArrayInstance(object obj, RuntimeTypeHandle typeHandle, int rank)
        {
            ...
            if (tw1 != null)
            {
                RuntimeJavaType tw2 = RuntimeClassLoader.GetWrapperFromType(Type.GetTypeFromHandle(typeHandle)).MakeArrayType(rank);
