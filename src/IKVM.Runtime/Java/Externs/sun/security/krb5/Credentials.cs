...
namespace IKVM.Java.Externs.sun.security.krb5
{
    ...
    static class Credentials
    {
        ...
        private static global::java.util.Date ToJavaDate(long time)
        {
            ...
            return new global::java.util.Date((time / 10000) - DIFF_IN_MILLIS);
        }
        ...
        public static object acquireDefaultNativeCreds(int[] eTypes)
        {
            ...
            return global::java.lang.Class.forName("sun.security.krb5.Credentials")
                .getConstructor(typeof(byte[]),
                                ...
                                typeof(int),
                                typeof(bool[]),
                                typeof(global::java.util.Date),
                                typeof(global::java.util.Date),
                                typeof(global::java.util.Date),
                                typeof(global::java.util.Date),
                                typeof(global::java.net.InetAddress[]))
                .newInstance(ticket.EncodedTicket,
                                ticket.ClientNames[0],
                                ticket.TargetNames[0],
                                ticket.SessionKey,
                                global::java.lang.Integer.valueOf(ticket.SessionKeyType),
                                null,
