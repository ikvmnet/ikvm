        ...
        sealed class FastFieldReflector : global::ikvm.@internal.FieldReflectorBase
        {
            ...
            internal FastFieldReflector(global::java.io.ObjectStreamField[] fields)
            {
                ...
                else
                {
                    ...
                    var dmObjGetter = DynamicMethodUtil.Create("__<ObjFieldGetter>", tw.TypeAsBaseType.GetUnderlyingRuntimeType(), true, null, [typeof(object), typeof(object[])]);
                    var dmPrimGetter = DynamicMethodUtil.Create("__<PrimFieldGetter>", tw.TypeAsBaseType.GetUnderlyingRuntimeType(), true, null, [typeof(object), typeof(byte[])]);
                    var dmObjSetter = DynamicMethodUtil.Create("__<ObjFieldSetter>", tw.TypeAsBaseType.GetUnderlyingRuntimeType(), true, null, [typeof(object), typeof(object[])]);
                    var dmPrimSetter = DynamicMethodUtil.Create("__<PrimFieldSetter>", tw.TypeAsBaseType.GetUnderlyingRuntimeType(), true, null, [typeof(object), typeof(byte[])]);
