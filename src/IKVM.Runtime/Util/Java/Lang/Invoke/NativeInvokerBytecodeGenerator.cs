...
namespace IKVM.Runtime.Util.Java.Lang.Invoke
{
    ...
    sealed class NativeInvokerBytecodeGenerator
    {
        ...
        NativeInvokerBytecodeGenerator(RuntimeContext context, java.lang.invoke.LambdaForm lambdaForm, global::java.lang.invoke.MethodType invokerType)
        {
            ...
            this.dm = new DynamicMethod(lambdaForm.debugName, mi.ReturnType.GetUnderlyingRuntimeType(), paramTypes.GetUnderlyingRuntimeTypes(), typeof(object).Module, true);
        ...
        private Delegate generateCustomizedCodeBytes()
        {
            ...
            ilgen.DoEmit();
            return dm.CreateDelegate(delegateType.GetUnderlyingRuntimeType(), constants.ToArray());
        }
