...
namespace IKVM.Runtime
{
    ...
    sealed class RuntimeTypicalJavaMethod : RuntimeSmartJavaMethod
    {
        ...
        internal RuntimeTypicalJavaMethod(RuntimeJavaType declaringType, string name, string sig, MethodSymbol method, RuntimeJavaType returnType, RuntimeJavaType[] parameterTypes, Modifiers modifiers, MemberFlags flags) :
