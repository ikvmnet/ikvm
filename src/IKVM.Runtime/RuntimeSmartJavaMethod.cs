...
namespace IKVM.Runtime
{
    ...
    abstract class RuntimeSmartJavaMethod : RuntimeJavaMethod
    {
        ...
        internal RuntimeSmartJavaMethod(RuntimeJavaType declaringType, string name, string sig, MethodSymbol method, RuntimeJavaType returnType, RuntimeJavaType[] parameterTypes, Modifiers modifiers, MemberFlags flags) :
