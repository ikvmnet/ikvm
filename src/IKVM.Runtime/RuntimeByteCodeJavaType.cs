...
#endif
    {
        ...
        private void VerifyDelegate(ClassFile f)
        {
            ...
            if (constructor.Instructions.Length < 3
                || constructor.Instructions[0].NormalizedOpCode != NormalizedOpCode._aload
                || constructor.Instructions[0].NormalizedArg1 != 0
                || constructor.Instructions[1].NormalizedOpCode != NormalizedOpCode._invokespecial
                || constructor.Instructions[2].NormalizedOpCode != NormalizedOpCode._return)
            {
