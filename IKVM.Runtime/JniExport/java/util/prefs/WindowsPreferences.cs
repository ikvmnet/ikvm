...
namespace IKVM.Runtime.JniExport.java.util.prefs
{
    ...
    static class WindowsPreferences
    {
        ...
        static class UACVirtualization
        {
            ...
            [DllImport("advapi32.dll")] private static extern int GetTokenInformation(IntPtr TokenHandle, TOKEN_INFORMATION_CLASS TokenInformationClass, out int TokenInformation, int TokenInformationLength, out int ReturnLength);
            ...
            internal static bool Enabled
            {
                ...
                get
                {
                    ...
                    return os.Platform != PlatformID.Win32NT || os.Version.Major < 6 ? false : GetTokenInformation(WindowsIdentity.GetCurrent().Token, TOKEN_INFORMATION_CLASS.TokenVirtualizationEnabled, out int enabled, 4, out int length) != 0 && enabled != 0;
                }
            }
