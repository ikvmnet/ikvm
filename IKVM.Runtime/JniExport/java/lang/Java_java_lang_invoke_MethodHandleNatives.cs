...
static class Java_java_lang_invoke_MethodHandleNatives
{
	...
	public static void init(java.lang.invoke.MemberName self, object refObj)
	{
	...
	public static void init(java.lang.invoke.MemberName self, object refObj, bool wantSpecial)
	{
#if !FIRST_PASS
	...
	private static void InitMethodImpl(java.lang.invoke.MemberName self, MethodWrapper mw, bool wantSpecial)
	{
#if !FIRST_PASS
		int flags = (int)mw.Modifiers;
		flags |= mw.IsConstructor ? java.lang.invoke.MethodHandleNatives.Constants.MN_IS_CONSTRUCTOR : java.lang.invoke.MethodHandleNatives.Constants.MN_IS_METHOD;
		if (mw.IsStatic)
		{
			flags |= java.lang.invoke.MethodHandleNatives.Constants.REF_invokeStatic << java.lang.invoke.MethodHandleNatives.Constants.MN_REFERENCE_KIND_SHIFT;
		}
		else if (mw.IsConstructor && !wantSpecial)
		{
			flags |= java.lang.invoke.MethodHandleNatives.Constants.REF_newInvokeSpecial << java.lang.invoke.MethodHandleNatives.Constants.MN_REFERENCE_KIND_SHIFT;
		}
		else if (mw.IsPrivate || mw.IsFinal || mw.IsConstructor || wantSpecial)
		{
			flags |= java.lang.invoke.MethodHandleNatives.Constants.REF_invokeSpecial << java.lang.invoke.MethodHandleNatives.Constants.MN_REFERENCE_KIND_SHIFT;
		}
		else if (mw.DeclaringType.IsInterface)
		{
			flags |= java.lang.invoke.MethodHandleNatives.Constants.REF_invokeInterface << java.lang.invoke.MethodHandleNatives.Constants.MN_REFERENCE_KIND_SHIFT;
		}
		else
		{
			flags |= java.lang.invoke.MethodHandleNatives.Constants.REF_invokeVirtual << java.lang.invoke.MethodHandleNatives.Constants.MN_REFERENCE_KIND_SHIFT;
		}
		if (mw.HasCallerID || DynamicTypeWrapper.RequiresDynamicReflectionCallerClass(mw.DeclaringType.Name, mw.Name, mw.Signature))
		{
			flags |= java.lang.invoke.MemberName.CALLER_SENSITIVE;
		}
		if (mw.IsConstructor && mw.DeclaringType == CoreClasses.java.lang.String.Wrapper)
		{
			...
			java.lang.invoke.MethodType mt = java.lang.invoke.MethodType.methodType(PrimitiveTypeWrapper.VOID.ClassObject, parameters1);
			self._type(mt);
			self._flags(flags);
		...
		self.vmtarget = CreateMemberNameDelegate(mw, mw.ReturnType.ClassObject, !wantSpecial, java.lang.invoke.MethodType.methodType(mw.ReturnType.ClassObject, parameters));
#endif
	}

#if !FIRST_PASS
	private static void SetModifiers(java.lang.invoke.MemberName self, MemberWrapper mw)
	{
		self._flags(self._flags() | (int)mw.Modifiers);
	}
#endif

	public static void expand(java.lang.invoke.MemberName self)
	{
		throw new NotImplementedException();
	}

	public static java.lang.invoke.MemberName resolve(java.lang.invoke.MemberName self, JlClass caller)
	{
#if !FIRST_PASS
		switch (self.getReferenceKind())
		{
			case java.lang.invoke.MethodHandleNatives.Constants.REF_invokeStatic:
				...
				break;
			case java.lang.invoke.MethodHandleNatives.Constants.REF_invokeVirtual:
				if (self.getDeclaringClass() == CoreClasses.java.lang.invoke.MethodHandle.Wrapper.ClassObject)
				{
					switch (self.getName())
					{
				...
				ResolveMethod(self, caller);
				break;
			case java.lang.invoke.MethodHandleNatives.Constants.REF_invokeInterface:
			case java.lang.invoke.MethodHandleNatives.Constants.REF_invokeSpecial:
			case java.lang.invoke.MethodHandleNatives.Constants.REF_newInvokeSpecial:
				ResolveMethod(self, caller);
				break;
			case java.lang.invoke.MethodHandleNatives.Constants.REF_getField:
			case java.lang.invoke.MethodHandleNatives.Constants.REF_putField:
			case java.lang.invoke.MethodHandleNatives.Constants.REF_getStatic:
			case java.lang.invoke.MethodHandleNatives.Constants.REF_putStatic:
				ResolveField(self);
				break;
			default:
				throw new InvalidOperationException();
...
#if !FIRST_PASS
	private static void ResolveMethod(java.lang.invoke.MemberName self, JlClass caller)
	{
		bool invokeSpecial = self.getReferenceKind() == java.lang.invoke.MethodHandleNatives.Constants.REF_invokeSpecial;
		bool newInvokeSpecial = self.getReferenceKind() == java.lang.invoke.MethodHandleNatives.Constants.REF_newInvokeSpecial;
		...
		if (mw == null)
		{
			if (self.getReferenceKind() == java.lang.invoke.MethodHandleNatives.Constants.REF_invokeInterface)
			{
		...
		if (self.getReferenceKind() == java.lang.invoke.MethodHandleNatives.Constants.REF_invokeVirtual && mw.DeclaringType.IsInterface)
		{
			throw new java.lang.IncompatibleClassChangeError("Found interface " + mw.DeclaringType.Name + ", but class was expected");
		}
		if (!mw.IsPublic && self.getReferenceKind() == java.lang.invoke.MethodHandleNatives.Constants.REF_invokeInterface)
		{
		...
		self._flags(self._flags() | (mw.IsConstructor ? java.lang.invoke.MethodHandleNatives.Constants.MN_IS_CONSTRUCTOR : java.lang.invoke.MethodHandleNatives.Constants.MN_IS_METHOD));
		if (self.getReferenceKind() == java.lang.invoke.MethodHandleNatives.Constants.REF_invokeVirtual && (mw.IsPrivate || mw.IsFinal || mw.IsConstructor))
		{
		...
		if (mw.HasCallerID || DynamicTypeWrapper.RequiresDynamicReflectionCallerClass(mw.DeclaringType.Name, mw.Name, mw.Signature))
		{
			self._flags(self._flags() | java.lang.invoke.MemberName.CALLER_SENSITIVE);
		}
	}

	private static void ResolveField(java.lang.invoke.MemberName self)
	{
		...
		self._flags(self._flags() | java.lang.invoke.MethodHandleNatives.Constants.MN_IS_FIELD);
		if (fw.IsStatic != IsReferenceKindStatic(self.getReferenceKind()))
		{
			...
			{
				case java.lang.invoke.MethodHandleNatives.Constants.REF_getField:
					newReferenceKind = java.lang.invoke.MethodHandleNatives.Constants.REF_getStatic;
					break;
				case java.lang.invoke.MethodHandleNatives.Constants.REF_putField:
					newReferenceKind = java.lang.invoke.MethodHandleNatives.Constants.REF_putStatic;
					break;
				case java.lang.invoke.MethodHandleNatives.Constants.REF_getStatic:
					newReferenceKind = java.lang.invoke.MethodHandleNatives.Constants.REF_getField;
					break;
				case java.lang.invoke.MethodHandleNatives.Constants.REF_putStatic:
					newReferenceKind = java.lang.invoke.MethodHandleNatives.Constants.REF_putField;
					break;
				default:
					throw new InvalidOperationException();
			}
			int flags = self._flags();
			flags -= self.getReferenceKind() << java.lang.invoke.MethodHandleNatives.Constants.MN_REFERENCE_KIND_SHIFT;
			flags += newReferenceKind << java.lang.invoke.MethodHandleNatives.Constants.MN_REFERENCE_KIND_SHIFT;
			self._flags(flags);
		}
	}
	...
	public static int getMembers(JlClass defc, string matchName, string matchSig, int matchFlags, JlClass caller, int skip, java.lang.invoke.MemberName[] results)
	{
#if FIRST_PASS
		return 0;
#else
		if (matchName != null || matchSig != null || matchFlags != java.lang.invoke.MethodHandleNatives.Constants.MN_IS_METHOD)
		{
			throw new NotImplementedException();
		}
		...
		for (int i = skip, len = Math.Min(results.Length, methods.Length - skip); i < len; i++)
		{
			...
			{
				results[i - skip] = new java.lang.invoke.MemberName((JlReflect.Method)methods[i].ToMethodOrConstructor(true), false);
			}
		}
	...
	public static long objectFieldOffset(java.lang.invoke.MemberName self)
	{
#if FIRST_PASS
		return 0;
#else
	...
	public static long staticFieldOffset(java.lang.invoke.MemberName self)
	{
		return objectFieldOffset(self);
	}

	public static object staticFieldBase(java.lang.invoke.MemberName self)
	{
		return null;
	}
	...
	public static void setCallSiteTargetNormal(JlInvoke.CallSite site, java.lang.invoke.MethodHandle target)
	{
#if !FIRST_PASS
		if (site.ics == null)
		{
	...
	public static void setCallSiteTargetVolatile(JlInvoke.CallSite site, java.lang.invoke.MethodHandle target)
	{
	...
	public static object getMemberVMInfo(java.lang.invoke.MemberName self)
	{
#if FIRST_PASS
		return null;
#else
		...
		if (java.lang.invoke.MethodHandleNatives.refKindDoesDispatch(self.getReferenceKind()))
		{
	...
	public static int getNamedCon(int which, object[] name)
	{
		...
		return 0;
#else
		FieldInfo[] fields = typeof(java.lang.invoke.MethodHandleNatives.Constants).GetFields(BindingFlags.Static | BindingFlags.NonPublic);
