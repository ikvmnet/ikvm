...
static class Java_sun_management_MemoryImpl
{
    public static object getMemoryPools0()
    {
		...
		return null;
#else
        return new java.lang.management.MemoryPoolMXBean[0];
#endif
    }
    ...
    public static object getMemoryManagers0()
    {
		...
		return null;
#else
        return new java.lang.management.MemoryManagerMXBean[0];
#endif
    }
    ...
    public static object getMemoryUsage0(object impl, bool heap)
    {
        ...
        return new java.lang.management.MemoryUsage(-1, mem, mem, -1);
#endif
    }
